...
SISBBT é uma interface de consulta aos **livros** do acervo Biblioteca Setorial do Departamento de Fitopatologia da Universidade Federal de Viçosa. A tabela ao lado está ordenada pelo ano mais recente de publicação. 


Como utilizar

> Insira o termo a consultar no campo de busca livre acima da tabela. Para voltar, use "backspace" para limpar o campo de busca.
